...
class Settings(BaseSettings):
    ...
    single_user_id: str = Field(default="00000000-0000-0000-0000-000000000000", alias="TILLU_USER_ID")
    ...
    hf_inference_api_url: str = Field(
        default="https://api-inference.huggingface.co", alias="HF_INFERENCE_API_URL"
    )
    hf_embedding_model: str = Field(
        default="sentence-transformers/all-mpnet-base-v2", alias="HF_EMBEDDING_MODEL"
    )
    ...
    hf_summarizer_model: str = Field(
        default="facebook/bart-large-cnn", alias="HF_SUMMARIZER_MODEL"
    )
    hf_ner_model: str = Field(
        default="dbmdz/bert-large-cased-finetuned-conll03-english", alias="HF_NER_MODEL"
    )
    hf_whisper_model: str = Field(
        default="openai/whisper-medium", alias="HF_WHISPER_MODEL"
    )
    ...
    news_api_key: Optional[str] = Field(
        default=None, alias="NEWSAPI_KEY"
    ...
    searxng_url: str = Field(
        default="https://tillu-ai-tillu-searxng.hf.space", alias="SEARXNG_URL"
    )
    websearch_url: str = Field(
        default="https://tillu-ai-tillu-websearch.hf.space", alias="WEBSEARCH_URL"
    )
    playwright_service_url: str = Field(
        default="http://localhost:3001", alias="PLAYWRIGHT_SERVICE_URL"
    )
    ...
    # Local OS bridge / daemon relay
    os_bridge_enabled: bool = Field(default=False, alias="OS_BRIDGE_ENABLED")
    os_daemon_url: str = Field(default="http://127.0.0.1:9999", alias="OS_DAEMON_URL")
    os_daemon_key: Optional[str] = Field(default=None, alias="OS_DAEMON_KEY")
    os_request_timeout_seconds: int = Field(
        default=30, alias="OS_REQUEST_TIMEOUT_SECONDS"
    )
    os_shell_enabled: bool = Field(default=False, alias="OS_SHELL_ENABLED")
    os_file_delete_enabled: bool = Field(default=False, alias="OS_FILE_DELETE_ENABLED")
    ...
    internal_secret: Optional[str] = Field(default=None, alias="INTERNAL_SECRET")
